    ...
    return (
        ...
        <section className="cw-grid py-4 py-xs-4">
            <div className="cw-col-12 cw-col-xs-12">
                ...
                <p className="mt-4">
                    Många märker först efter midsommar hur rörigt det kan bli utan rätt fraktlösning.
                    Hos Hilja Logistics får du hjälp att välja rätt transportpartner – snabbt, flexibelt och via Fraktjakt.
                    
                    <br/>
                    <br/>

                    Fyll i formuläret nedan så kontaktar vi dig för en gratis konsultation – så du slipper fler logistikmissar.
                </p>
            </div>
        </section>
        <div id="form" className={style.container}>
            <form className="cw-grid gap-1 pb-4 pb-xs-4" onSubmit={handleSubmit}>
                ...
                <div className={`cw-col-6 cw-col-xs-12 ${style.inputWraper}`}>
                    <input
                        type="text"
                        name="phone"
                        placeholder="Telefon"
                ...
                />
                <button className="cw-col-12 cw-col-xs-12">Skicka</button>
            </form>
        </div>
        </>
    );
